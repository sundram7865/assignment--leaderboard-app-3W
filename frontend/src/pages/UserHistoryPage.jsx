                ...
                <Table>
                  <TableHead>
                    <TableRow sx={{ 
                      ...
                      {!userId && (
                        <TableCell sx={{ color: 'white !important', fontWeight: 600 }}>
                          User
                        </TableCell>
                      )}
                      <TableCell sx={{ color: 'white !important', fontWeight: 600 }}>Points</TableCell>
                      <TableCell sx={{ color: 'white !important', fontWeight: 600 }}>Date</TableCell>
                      <TableCell sx={{ color: 'white !important', fontWeight: 600 }}>Time</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {history.map((record, index) => (
                      <Grow in={!loading} timeout={index * 100} key={record._id}>
                        <TableRow 
                          hover 
                          sx={{ 
                            '&:nth-of-type(odd)': { 
