        ...
        <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
          ...
          <div className="mt-4 md:mt-0 flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <button className="relative px-4 py-2 text-sm font-medium text-white bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-200">
                View History
              </button>
            </div>
          </div>
